...
def test_4118600(load_4118600_response, load_madrid_spider):
    ...
    assert item['fecha_convocatoria'] == '2021-05-26 12:30'
    assert item['estado'] == 'En tramitación'
    assert item['fecha_fin_presentacion'] == '2021-06-29'
    ...
    assert item['fecha_limite_de_presentacion_de_ofertas_o_solicitudes_de_participacion'] == '2021-06-29 14:00'
    ...
    assert item['adjudicacion_del_contrato_publicada_el'] == '2021-09-22'
